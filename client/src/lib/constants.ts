...
export const NAV_ITEMS: NavItem[] = [
    ...
    { label: 'Payrolls', path: '/payroll', icon: 'Wallet', requiredPermission: 'payrolls' },
    {
        ...
        children: [
            ...
            { label: 'Impagos', path: '/payments/dunning', requiredPermission: 'dunning' },
            { label: 'Configuración de impagos', path: '/payments/dunning/config', requiredPermission: 'dunning' },
        ],
    },
